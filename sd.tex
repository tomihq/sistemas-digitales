...
Todas las operaciones que implican accesos a memoria, los valores inmediatos se indican en bytes. Ej: lw, sw. \\ 
Todas las operaciones que implican operaciones aritméticas o lógicas, los valores inmediatos se indican en bits. Ej: srli \\
...
\subsection*{Escritura y Lectura en Memoria} 
...
Equivale a 
\begin{lstlisting}
    # s1: numbersArr, s7: five
    lw s7, 20(s1)   
\end{lstlisting}
Donde 20(s1) es el número 5 y ocupa desde el bit 20 hasta el 24 (1 byte).
...
\begin{itemize}
    ...
    \item \(sw, \ t3, \ 20(s3) (se desplaza desde s3 20 bytes)\)
\end{itemize}
