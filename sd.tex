...
La forma de poder agrandar un Datapath es agregando multiplexores. \\  
...
\begin{itemize}
    \item Program Counter (CPU): Contiene la instrucción actual, PCNext es una entrada que indica la próxima instrucción.
    ...
    \item Register File (CPU): Posee dos puertos de lectura (RD1 y RD2) que vuelcan el valor de las entradas de escritura (A1 y A2) respectivamente. WD3 también es un puerto de entrada de escritura que escribe el dato en A3 durante el flanco ascendente del reoj si la señal de control WE3 se encuentra alta.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item El clock cambia de estado, escribiendo en WD3 el resultado de la ALU.
    \end{itemize}
    \item El clock cambia de estado. 
