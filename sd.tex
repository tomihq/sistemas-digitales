...
Nos permiten ponerle nombre a subproblemas.
\[\begin{minipage}[b]{0.6\textwidth}
...
\begin{itemize}
    ...
    \item Regla para la llamada: Si va a utilizar los registros permanentes (s0-s11, ra) debe guardarlos al comenzar y restaurarlos antes de retornar.ar
\end{itemize}
