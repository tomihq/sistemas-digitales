...
\subsection*{Entrada de control Enable}
La entrada de control Enable nos permitirá decirle al Flip-Flop cuando nosotros queremos permitir que nos cambie el valor / escriba la memoria. \\
...
Recuerdo: El Flip Flop D solo almacena 1 bit. Si necesitaramos almacenar n bits necesitaríamos n Flip Flop D y UN solo Enable/Clock.
