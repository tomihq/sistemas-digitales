...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.6\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{assets/registros_ex1.png}
        \caption*{Paso 1: Utilizo 3 Flip-Flop D con la posibilidad de escribir cuando el clock está activo y un botón de reset}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.6\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{assets/registros_ex2.png}
        \caption*{Paso 2: Se añade un EnableOut para que se muestre el dato almacenado con lo armado en el paso 1.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.6\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{assets/registros_ex3.png}
        \caption*{Paso 3: TODO revisar}
    \end{subfigure}
\end{figure}
...
¿Qué valores deberían tener \(D_{1} \ y \ D_{0}\) para obtener los valores deseados en el tiempo t+1, es decir, \(Q_{1}(t+1) y Q_{0}(t+1)\) Para esto usamos \textbf{lógica de próximo estado} \\
Para esto usamos un flip-flop D, para que en vez de usar asignaciones dependa del estado anterior.
\[\begin{minipage}[b]{0.4\textwidth}
...
Veamos un claro ejemplo donde tenemos que hacer uso de la lógica de salida porque debemos conocer el estado para poder conocer el siguiente valor. ¿Cúal sería la siguiente salida si la entrada es 01? Puede ser 11 o 00. 
\[\begin{minipage}[b]{0.4\textwidth}
