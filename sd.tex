...
\textbf{Lectura}: Instrucción lw (load word); Es importante que lw carga \textbf{un registro que tiene un puntero hacia la RAM.} \\ 
\[lw \ registroDestino, \ registroPunteroARam\] 
Nota: se guarda en registroDestino, el registro que tiene un puntero a la RAM. \\ \\
\textbf{Escritura}: Instrucción sw (store word); Es importante que sw guarda el contenido en \textbf{un registro que tiene un puntero hacia la RAM.}
\[sw \ contenido, \ registroPunteroARam\] 
Nota: se guarda en contenido, el registro que tiene un puntero a la RAM. \\
\textbf{Importante: registroPunteroARam, en todos los casos debe ser un puntero a la RAM y debe haber sido inicializada.}
Véase \hyperref[subsec:punteros_ram_registros]{\underline{anexo}} 
