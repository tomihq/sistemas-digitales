...
Un ejemplo podría ser \#0x001010 AND \#0x00 = \#0x000000 \\
Si bien este es un ejemplo que deja mucho que desear, véase \hyperref[subsec:byte_particular_desplazamiento]{\underline{la sección de colores RGB para obtener un color en particular (2 bytes) desplazando bits.}}
\subsection*{Instrucciones lógicas en RISC V}
Sean dos registros cualesquiera, las operaciones lógicas se hacen bit a bit. Sirven para utilizar máscaras \\
