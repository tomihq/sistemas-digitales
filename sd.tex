...
\begin{itemize}
    ...
    \item Aplica un lui: carga los primeros 20 bits, pero antes extiende el número con 0's. Luego, guarda el resultado del lui.
    \item Hace un addi utilizando el resultado del proceso anterior y los 12 bits menos significativos del número inicial. 
\end{itemize}
\textbf{1}.  
