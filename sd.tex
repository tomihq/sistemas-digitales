...
\textbf{Ojo: Las operaciones que son inmediatas son fórmulas compuestas. Es decir, no toman una sola posición de memoria sino que toman varias porque son alias para operaciones compuestas. Ej: li a0, 4228 hace un lui y un addi (esto es porque 4228 es muy grande creo, porque si uso algo más chico no se hace una operación demás. Solo hace el lui a partir de 2048)}
...
Nota: La asignación (=) es bloqueante mientras que la asignación ($ < = $) es no bloqueante.
...
Véase \hyperref[subsec:SVL_comp]{anexo} para un ejemplo. \\
...
Véase \hyperref[subsec:SVL_bloques_clk]{anexo} para un ejemplo. \\
\[bloque \ @(evento \ var)\]
