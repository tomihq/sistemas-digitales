...
\begin{itemize}
    ...
    \begin{itemize}
        \item Ej: slli en una unidad multiplica un número por dos. Ej: 10 (2) y desplazo una unidad a la izquierda el resultado es 100 (4).
    \end{itemize}
    ...
    \begin{itemize}
        \item Ej: srli en una unidad divide un número por dos. Ej: 10 (2) y desplazo una unidad a la derecha el resultado es 01 (1).
    \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Aplicamos la máscara de 0x33 (0x33333333 - extendido con MSB) y guardamos el resultado
    \begin{itemize}
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/stack_frame.png}
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/reglas_llamada.png}
...
\[\begin{minipage}[b]{0.6\textwidth}
    \includegraphics[width=\linewidth]{assets/pseudoinstrucciones.png}
