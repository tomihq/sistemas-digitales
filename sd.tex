...
\begin{itemize}
    \item Desplazamiento hacia la izquierda: \(variable << cantidad\)\\ \begin{minipage}[b]{0.3\textwidth}
    ...
    \item Desplazamiento aritmético hacia la derecha: \(variable >>_{a} cantidad\)\\ \begin{minipage}[b]{0.3\textwidth}
