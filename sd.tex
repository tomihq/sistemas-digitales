...
\begin{itemize}
    \item 1. \(\overline{\bar{X} \ast Y} \ast Z + X \ast \bar{Z} + \textcolor{blue}{(\bar{Y} \ast \bar{Z})} \implies De \ Morgan\) 
    \item 2. \(\textcolor{blue}{(X + \bar{Y})} \ast Z + \textcolor{purple}{X \ast \bar{Z}} + \textcolor{purple}{(\bar{Y} \ast \bar{Z})}\implies De \ Morgan \ \land \ Distributiva \) 
    \item 3. \((X + \bar{Y}) \ast Z + \bar{Z} \ast (X + \bar{Y})\)
    \item 4. \((X + \bar{Y}) \ast \textcolor{red}{(Z + \bar{Z})} \implies Inverso\) 
    \item 5. \((X + \bar{Y}) \ast \textcolor{cyan}{1} \implies Identidad \) 
    \item 6. \((X + \bar{Y})\)
\end{itemize}
